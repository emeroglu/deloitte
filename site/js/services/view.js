$js.compile("$view", null, function($public, $private, $protected, $self) {
    ...
    $private.field.types = [AbsoluteLayout, BannerView, HorizontalListView, ImageView, ListItemView, ListView, RelativeLayout, ReflectiveTextView, SearchView, StoreSelectorView, TextView];
